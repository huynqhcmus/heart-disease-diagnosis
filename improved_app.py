...
if st.session_state.pipeline_initialized:
        ...
        if st.session_state.predictions:
            ...
            if selected_contrib_model:
                try:
                    ...
                    model_result = next((r for r in all_results if r['Model'] == selected_contrib_model), None)
                    
                    if model_result:
                        prediction_result = "Heart Disease" if model_result['Prediction'] == "High Risk" else "No Heart Disease"
                        ...
                        if contributions:
                            ...
                            with col1:
                                ...
                                if contrib_fig:
                                    ...
                                    st.warning("Could not generate contribution visualization.")
                            ...
                            if recommendations_data['recommendations']:
                                ...
                                with st.expander("📅 Implementation Timeline & Next Steps"):
                                    st.markdown("""
                                    **📋 Implementation Timeline:**
                            ...
                            st.warning(f"Could not calculate contributions for {selected_contrib_model}. This might be due to model compatibility issues.")
                    else:
    ...
    with tab3:
        ...
        if st.session_state.predictions and pipeline.models:
            ...
            selected_model_name = st.selectbox("Select Model for Global Feature Importance", model_names)
